      ...
      <div className='flex flex-col gap-1.5 w-full'>
        ...
        <div className='relative flex items-center'>
          ...
          <input
            ...
            className={cn(
              'flex h-10 w-full rounded-md border border-gray-400 bg-white py-2 px-4 text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:cursor-not-allowed disabled:opacity-50',
