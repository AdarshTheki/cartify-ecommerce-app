...
const ImagePreview = React.memo(({ preview, closePreview, className = '' }: ImagePreviewProp) => {
  ...
  return (
    <div
      ...
      <div className='max-w-[420px] w-full px-2 animate-in fade-in zoom-in-95 relative'>
        ...
        <img src={preview} alt='image-preview' className='w-full max-h-[80vh] object-contain' />
      </div>
    </div>
  );
});
